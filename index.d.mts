...
declare const verifyWithAbgx360: (args?: string[], options?: AbgxOptions, onProgress?: (progress: string) => void) => Promise<AbgxFile[]>;
declare const getIsosInfo: (isoPaths?: string[]) => Promise<IsoInfo[]>;
//#endregion
export { AbgxFile, AbgxOptions, AbgxStatus, IsoInfo, Region, getIsosInfo, verifyWithAbgx360 };